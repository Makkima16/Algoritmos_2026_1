...
SAMPLES_DIR = Path(__file__).resolve().parent / "GeoMIP" / "data" / "samples"
...
def main():
    parser = argparse.ArgumentParser(
        description="Visor paginado de TPM en formato CSV (proyecto GeoMIP)."
    )
    parser.add_argument(
        "--archivo", "-f",
