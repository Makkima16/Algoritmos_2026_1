# -*- coding: utf-8 -*-
"""
Script de ejecución interactivo para QNodes — k-Partición de Mínima Información (DP + B&B)
...
Formato del CSV para modo bloque:
  ...
  - El resultado se guarda automáticamente en QNodes/results/block/ como .xlsx.
"""
...
def _guardar_resultado_single(
    ...
    """Guarda el resultado de una ejecución manual en QNodes/results/manual/."""
...
def modo_manual(ruta_archivo: Path, tpm: np.ndarray, n_nodos: int):
    ...
    # ── Resumen y ejecución ────────────────────────────────────────────────
    sep(" Iniciando Algoritmo — QNodes k-Partición Óptima Global")
...
def main():
    ...
    sep(" QNodes — k-Partición de Mínima Información (Óptimo Global)")
    ...
    if opcion == "2":
        ...
        sep(" Ejecución Manual — QNodes Óptimo Global")
