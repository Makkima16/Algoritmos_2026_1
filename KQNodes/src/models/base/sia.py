...
class SIA(ABC):
    ...
    def sia_preparar_subsistema(
        ...
        # Tiempo de preparación del subsistema ("calentar motores"): construcción
        # del sistema, condicionado y substracción. Se reporta aparte del tiempo
        # de búsqueda del algoritmo.
        self.sia_tiempo_preparacion = time.time() - t_prep_start
